...
export const PAGE_CARDS: PageCardConfig[] = [
  ...
  },
  {
    ...
    route: "/ceo/bot",
    icon: Bot,
    description: "Configurações detalhadas de ciclo de vida, perfil visual, presença, intenções privilegiadas e integração Discloud.",
    color: "border-indigo-500/40 bg-indigo-500/5 text-indigo-400",
    defaultCat: "CEO",
    defaultOrder: 1,
    permissions: [
      ...
      },
      {
        key: "bot_restart",
        label: "Reiniciar Bot",
        description: "Permite emitir o comando para reiniciar a aplicação do bot no Discloud.",
        badge: "Ciclo de Vida",
      },
      {
        key: "bot_power_toggle",
        label: "Ligar / Desligar Bot",
        description: "Permite iniciar ou parar a instância do bot no Discloud.",
        badge: "Ciclo de Vida",
      },
      {
        key: "bot_manage_token",
        label: "Remover / Alterar Configurações do Token Bot",
        description: "Permite visualizar, colar, testar, alterar ou remover o token de acesso do bot.",
        badge: "Segurança Crítica",
        importantNote: "Concede controle sobre as credenciais de autenticação do bot no Discord.",
      },
      {
        key: "bot_view_intents",
        label: "Visualizar Opções de Intenção Privilegiada",
        description: "Permite visualizar o painel de Gateway Intents (Presença, Membros e Conteúdo de Mensagem).",
        badge: "Gateway Discord",
      },
      {
        key: "bot_change_intents",
        label: "Mudar Opções de Intenção Privilegiada",
        description: "Permite ativar ou desativar as intenções privilegiadas do bot no Discord.",
        badge: "Gateway Discord",
        importantNote: "Alterações indevidas podem impedir o bot de ler mensagens ou sincronizar membros.",
      },
      {
        key: "bot_manage_discloud_config",
        label: "Remover / Alterar Configurações do Discloud",
        description: "Permite alterar App ID, token da API Discloud ou remover as credenciais de integração com a nuvem.",
        badge: "Nuvem Discloud",
      },
    ],
  },
];
