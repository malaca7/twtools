...
export const DEFAULT_BOT_PROJECT: BotProject = {
  ...
  description: "Bot automatizado oficial para atendimento, avisos, logs e automações do grupo Twin Wheels.",
  prefix: "!",
      ...
      actions: [
        {
          ...
          config: {
            ...
            description: "Olá {{user.mention}}! Seja muito bem-vindo à família Twin Wheels.\n\nPor favor, dirija-se à sala de recrutamento para receber sua tag e orientações sobre os baús e regras do grupo.",
            color: "#10B981",
          },
        },
      ],
  ...
  variables: [
    {
      ...
      botId: "bot_twin_wheels_official",
      name: "meta_semanal",
      description: "Valor da cota semanal por membro do grupo",
      scope: "bot",
      type: "number",
      value: "50000",
    },
    {
      ...
      botId: "bot_twin_wheels_official",
      name: "status_msg",
      description: "Texto padrão de status do grupo",
      scope: "global",
      type: "string",
