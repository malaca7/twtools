...
const MASTER_NAV_ITEMS: MasterNavItem[] = [
  ...
  { id: "life", title: "Life (Feed)", url: "/life", icon: Flame, perm: "view_life", defaultCat: "Operação", defaultOrder: 3 },
  { id: "lives", title: "Lives", url: "/lives", icon: Radio, perm: "view_lives", defaultCat: "Operação", defaultOrder: 4 },
