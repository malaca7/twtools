...
function AuthenticatedLayout() {
  ...
  const isPublicProfilePath = (() => {
    ...
    return p.startsWith("/perfil/") && p !== "/perfil/dados" && p !== "/perfil/aparencia";
  })();
  ...
  // Se não estiver autenticado ou não tiver acesso aprovado:
  if (!user || !approvedAccess) {
    // Permite visualização pública do perfil sem login
