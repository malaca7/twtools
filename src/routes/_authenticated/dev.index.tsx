...
const ALL_SYSTEM_MODULES = [
  ...
  },
  {
    ...
    items: [
      { title: "Bot (Studio & Builder)", url: "/dev/bot?tab=builder", icon: Bot, desc: "Criação visual de comandos, eventos, timers e automações de bot no estilo BotGhost", color: "text-emerald-400" },
      { title: "Gerenciar Bot Discord", url: "/dev/bot?tab=bot-manage", icon: Bot, desc: "Perfil oficial do bot, presença, tokens, invite e reinicialização na nuvem", color: "text-indigo-400" },
      { title: "Webhooks do Discord", url: "/dev/bot?tab=webhooks", icon: Webhook, desc: "Gestão, provisionamento automático e testes de canais e webhooks", color: "text-purple-400" },
      { title: "Canais & Logs do Bot", url: "/dev/bot?tab=discord-logs", icon: Terminal, desc: "Mapeamento de canais para envio de logs automáticas e cores de embeds", color: "text-cyan-400" },
      ...
      { title: "Limpeza de Cache & Geral", url: "/dev/configuracao?tab=general", icon: RefreshCw, desc: "Forçar limpeza de cache dos navegadores e recarregar clientes via Realtime", color: "text-cyan-400" },
