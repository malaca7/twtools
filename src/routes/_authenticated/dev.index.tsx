...
const ALL_SYSTEM_MODULES = [
  ...
  },
  {
    ...
    items: [
      { title: "Bot (Studio & Builder)", url: "/dev/bot/builder", icon: Bot, desc: "Criação visual de comandos, eventos, timers e automações de bot no estilo BotGhost", color: "text-emerald-400" },
      { title: "Gerenciar Bot Discord", url: "/dev/bot/bot-manage", icon: Bot, desc: "Perfil oficial do bot, presença, tokens, invite e reinicialização na nuvem", color: "text-indigo-400" },
      { title: "Webhooks do Discord", url: "/dev/bot/webhooks", icon: Webhook, desc: "Gestão, provisionamento automático e testes de canais e webhooks", color: "text-purple-400" },
