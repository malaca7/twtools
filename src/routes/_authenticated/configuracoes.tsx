...
const DEFAULT_ITEMS: MenuItemConfig[] = [
  ...
  { id: "estoque", title: "Controle de Estoque", url: "/estoque", visible: true, category: "Gestão", order: 3 },
  { id: "membros", title: "Membros", url: "/membros", visible: true, category: "Gestão", order: 4 },
  { id: "hierarquia", title: "Hierarquia", url: "/hierarquia", visible: true, category: "Gestão", order: 5 },
  { id: "fundo-caixa", title: "Fundo de Caixa", url: "/fundo-caixa", visible: true, category: "Gestão", order: 6 },
  { id: "rankings", title: "Rankings", url: "/rankings", visible: true, category: "Gestão", order: 7 },
  { id: "desempenho", title: "Meu Desempenho", url: "/desempenho", visible: true, category: "Gestão", order: 8 },
  { id: "metas", title: "Metas", url: "/metas", visible: true, category: "Gestão", order: 9 },
  { id: "cargos", title: "Gerenciamento de Cargos", url: "/cargos", visible: true, category: "Gestão", order: 10 },
  { id: "permissoes", title: "Permissões", url: "/permissoes", visible: true, category: "Gestão", order: 11 },
  { id: "avisos", title: "Enviar Avisos", url: "/avisos", visible: true, category: "Gestão", order: 12 },
  { id: "logs", title: "Logs", url: "/logs", visible: true, category: "Gestão", order: 13 },
  { id: "perfil", title: "Meu Perfil", url: "/perfil", visible: true, category: "Gestão", order: 14 },
  { id: "configuracoes", title: "Configurações", url: "/configuracoes", visible: true, category: "Gestão", order: 15 },
];
